...
contract RockPaperScissors {
    ...
    function _getDomainHash() private view returns (bytes32 eip712DomainHash) {
        ...
        eip712DomainHash = keccak256(
            abi.encode(
                ...
                keccak256(bytes("RockPaperScissors")),
                keccak256(bytes("1")),
                chainId,
                address(this)
            )
    ...
    function take(
        ...
        uint256 takerAllowance = IERC20(payoutToken).allowance(msg.sender, address(this));
        ...
        uint256 makerAllowance = IERC20(payoutToken).allowance(maker, address(this));
    ...
    function claimUnrevealed(bytes32 betId) external {
        ...
        require(block.timestamp < takenBets[betId].deadline, "Bet expired");
